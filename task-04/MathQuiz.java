...
public class MathQuiz extends JFrame {
    ...
    public MathQuiz() {
        ...
        radioButton4 = new JRadioButton("Divide (Round the answer to 2 decimal places)");
        ...
        radioButton3.addActionListener(new multiplyListener());
    ...
    class starterListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            num2 = (int)(Math.random() * 6 + 1); // I added this functionality to prevent questions where 0 is returned as divisor
    ...
    class advancedListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            num2 = (int)(Math.random() * 21 + 1); // Added it here again to prevent situations with 0 as divisor
    ...
    class startListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if (interval != 4 && interval != 3 && interval != 2 && interval != 1) {
                ...
                num2 = (int)(Math.random() * 100 + 1); // Added it again :p
            }
            ...
            if (operator == 1) {
            	...
            	double temp = (double)num1 / num2; // I used a temp value so that the code can be read a bit more easily.
                result = (double) Math.round(temp * 100) / 100; //formula
                question = ("" + num1 + "/" + num2); //question label content
            } else {
                result = num1 + num2; //formula 
                question = ("" + num1 + "+" + num2); //question label content
        ...
        public void keyPressed(KeyEvent e) {
            ...
            if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                ...
                if (interval == 1) {
                    ...
                    num2 = (int)(Math.random() * 6 + 1); //Confirm Lenna is super bad at math lol
                } else if (interval == 2) {
                    num1 = (int)(Math.random() * 7 + 3);
                    num2 = (int)(Math.random() * 7 + 3);
                } else if (interval == 3) {
                    num1 = (int)(Math.random() * 21);
                    num2 = (int)(Math.random() * 21 + 1); //Wonder how she passed her high school :thinking_face:
                } else if (interval == 4) {
                    int doubleOfInterval1 = Integer.parseInt(interval1.getText());
                    int doubleOfInterval2 = Integer.parseInt(interval2.getText());
                ...
                if (operator == 1) {
                    ...
                    double temp = (double)num1 / num2; // Meh, I wonder why this had to be repeated twice
